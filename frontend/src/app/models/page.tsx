...
/**
 * Models Browser Page (/models)
 *
 * Card grid of all foundation models with attribute filters (size, license,
 * training method, etc.) and text search. Each card shows the model's metadata
 * and a summary of its benchmark rankings.
 */
...
import { useModelAttributeFilters } from "@/hooks/useModelAttributeFilters";
import { ModelAttributeFilterBar } from "@/components/filters/ModelAttributeFilterBar";
import { getLicenseLabel, getPublicationTypeLabel } from "@/lib/modelFilters";
...
export default function ModelsPage() {
  ...
  const attributeFilters = useModelAttributeFilters(models);

  // Apply search on top of attribute-filtered models
  const filteredModels = useMemo(() => {
    let result = attributeFilters.filteredByAttributes;
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <div className="mt-4 flex flex-wrap items-center gap-3">
          <ModelAttributeFilterBar filters={attributeFilters}>
            {/* Search */}
                ...
                <div className="flex justify-between items-start gap-2">
                  ...
                  <div className="flex flex-col gap-1 items-end">
                    ...
                    {model.publicationType && (
                      ...
                      >
                        {getPublicationTypeLabel(model.publicationType)}
                      </Badge>
                    )}
                  </div>
                </div>
