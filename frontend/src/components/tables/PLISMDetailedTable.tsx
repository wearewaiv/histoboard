...
export function PLISMDetailedTable({
  ...
  // Compute leaderboard score per model (average of all 4 metrics)
          ...
          <thead>
            <tr className="border-b bg-muted/50">
              ...
              {tasks.map((task) => (
                <th
                  key={task.id}
                  className="px-2 py-2 text-center font-semibold whitespace-nowrap min-w-[120px]"
                  title={task.name}
                >
                  <div className="text-xs truncate max-w-[120px]">{task.name}</div>
              ...
              <th className="px-2 py-2 text-center font-semibold whitespace-nowrap min-w-[100px] bg-muted/80">
                ...
                <div className="text-[10px] text-muted-foreground font-normal">Score</div>
              </th>
            </tr>
          </thead>
          <tbody>
